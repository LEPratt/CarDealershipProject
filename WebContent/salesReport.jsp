...
<%@ page import="carSalesSystem.SaleDetails"%>
...
<body>
      ...
      <ul class="navbar-nav mr-sm-1 ml-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown03">
            ...
            <a class="dropdown-item active" href="salesReport.jsp">Sales History</a>
          </div>
        </li>
      </ul>
    </div>
  ...
  <section id="showcase">
    <div class="container">
      ...
      <p class="lead">Text based history of all cars sold</p>
    </div>
  </section>
    ...
    <table class="table">
      ...
      <tbody>
        <c:forEach var="sale" items="${sales}">
          <tr>
            <td>
              <c:out value="${sale.saleDate}" />
            </td>
            <td>
              <c:out value="${sale.salePrice}" />
            </td>
            <td>
              <c:out value="${sale.buyerName}" />
            </td>
            <td>
              <c:out value="${sale.car.purchaseDate}" />
            </td>
            <td>
              <c:out value="${sale.car.year}" />
            </td>
            <td>
              <c:out value="${sale.car.make}" />
            </td>
            <td>
              <c:out value="${sale.car.model}" />
            </td>
            <td>
              <c:out value="${sale.car.vin}" />
            </td>
            <td>
              <c:out value="${sale.car.mileage}" />
            </td>
            <td>
              <c:out value="${sale.car.askingPrice}" />
            </td>
          </tr>
        </c:forEach>
      </tbody>
