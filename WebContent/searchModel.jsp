...
<%ArrayList<Car> modelFound = (ArrayList<Car>) session.getAttribute("modelFound");%>
...
<body>
      ...
      <ul class="navbar-nav mr-sm-1 ml-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu a:hover dropdown-menu-right" aria-labelledby="dropdown03">
            ...
            <a class="dropdown-item active" href="searchModel.jsp">Search by Model</a>
          </div>
        </li>
        <li class="nav-item dropdown">
  ...
  <section id="showcase">
    <div class="container">
      <h1 class="display-4">Search Model</h1>
      <p class="lead">List of our cars for sale by model</p>
    </div>
  </section>
  ...
  <div class="container">
    <div style="width: 300px; height: 75px;">
      ...
      <form class="form-inline" action="FindCarByModel" method="POST">

        Please Enter Manufacturer:<br><input type="text" name="searchModel"><br><br>
  ...
  <div class="container">
    <div class="card-deck mb-3 text-left">
      <c:forEach var="car" items="${modelFound}">
